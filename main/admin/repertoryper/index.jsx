...
class ZmitiRepertoryPerApp extends Component {
	constructor(props) {
		super(props);
      ...
      customRightComponent:<div className='repertorypub-main-ui' style={{height:this.state.mainHeight}}>
        <div className='pad-10'>
          <div className="zmiti-repertorypub-header">
              <Row>
                  <Col span={8} className="zmiti-repertorypub-header-inner">个人</Col>
...
export default ZmitiValidateUser(ZmitiRepertoryPerApp);
