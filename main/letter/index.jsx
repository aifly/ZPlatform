...
class ZmitiLetterApp extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		var title = this.props.params.title || '十九大';
		let props = {
			...
			customerComponent: <div>
                     			 <Row type="flex" justify="center" align="top">
												      <Col span={4}><Button type='primary' onClick={this.addQuestion.bind(this)}>新增评论</Button></Col>
	...
	componentWillMount() {
		...
		var index = -1;
		window.LETTERUSERLIST.forEach((item, i) => {
			if (item === username) {
				index = i;
			}
		});
...
export default ZmitiValidateUser(ZmitiLetterApp);
