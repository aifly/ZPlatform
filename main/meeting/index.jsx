...
class ZmitiMeetingApp extends Component {
	constructor(props) {
		super(props);
			...
			selectComponent:<Select placeholder='提问内容' onChange={this.changeCondition.bind(this)}  style={{width:120}} size='small' >
                     ...
                     customerComponent:<div>
                     			 <Row type="flex" justify="center" align="top">
												      <Col span={4}><Button type='primary' onClick={this.addQuestion.bind(this)}>新增问题</Button></Col>
                ...
                <Form >
                 ...
                 >
                  ...
                  <FormItem
                   ...
                   hasFeedback={true}
                 >
                   <textarea value={this.state.content} type='text' ref='qa-content' className='qa-content' placeholder='问题内容' onChange={(e)=>{this.setState({content:e.target.value})}}></textarea>
                 </FormItem>
	...
	componentDidMount() {
		...
		$.ajax({
			...
			success(data){
					if(data.getret === 0){
						s.setState({checked:data.status});
...
export default ZmitiValidateUser(ZmitiMeetingApp);
