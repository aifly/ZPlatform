...
!
    function(a) {
        ...
        a.extend(a.FE.POPUP_TEMPLATES, {
            ...
            colorsText: ["#1C1C1C","#55201D","#B00011","#F14036","#EA5501","#FFA054","#774C31","#B46D41","#363636","#7C1723","#EC0000","#F65952","#F38F5C","#FFB84C","#936B54","#DE9564","#4F4F4F","#AC2014","#ED1941","#FF8A6A","#FFAE6E","#FFD96E","#B79869","#EEBCA1","#696969","#55201D","#BF3535","#FFA194","#F1C996","#F1D9A0","#D1BB93","#FFDCBF","#808080","#890950","#C47E02","#75AB01","#008945","#028989","#36648A","#274089","#B3B3B3","#CB1076","#FDAE16","#A1CB02","#01CB66","#01CBCB","#4F92CB","#2A5FCB","#CDCDCD","#EC1287","#FFD500","#D1CE00","#77EA78","#00ECEC","#5CAAEC","#4370EC","#E6E6E6","#FF1491","#FCF16E","#DAFF71","#90FFB9","#82FFFF","#63C7FF","#3192FF","#FFFFFF","#7A3789","#B252CB","#CF5FEC","#DE66FF","#EC7AE7","#FF81F8","#61BD6D", "#1ABC9C", "#54ACD2", "#2C82C9", "#9365B8", "REMOVE"],//["#61BD6D", "#1ABC9C", "#54ACD2", "#2C82C9", "#9365B8", "#475577", "#CCCCCC", "#41A85F", "#00A885", "#3D8EB9", "#2969B0", "#553982", "#28324E", "#000000", "#F7DA64", "#FBA026", "#EB6B56", "#E25041", "#A38F84", "#EFEFEF", "#FFFFFF", "#FAC51C", "#F37934", "#D14841", "#B8312F", "#7C706B", "#D1D5D8",  "REMOVE"],
            colorsBackground:["#1C1C1C","#55201D","#B00011","#F14036","#EA5501","#FFA054","#774C31","#B46D41","#363636","#7C1723","#EC0000","#F65952","#F38F5C","#FFB84C","#936B54","#DE9564","#4F4F4F","#AC2014","#ED1941","#FF8A6A","#FFAE6E","#FFD96E","#B79869","#EEBCA1","#696969","#55201D","#BF3535","#FFA194","#F1C996","#F1D9A0","#D1BB93","#FFDCBF","#808080","#890950","#C47E02","#75AB01","#008945","#028989","#36648A","#274089","#B3B3B3","#CB1076","#FDAE16","#A1CB02","#01CB66","#01CBCB","#4F92CB","#2A5FCB","#CDCDCD","#EC1287","#FFD500","#D1CE00","#77EA78","#00ECEC","#5CAAEC","#4370EC","#E6E6E6","#FF1491","#FCF16E","#DAFF71","#90FFB9","#82FFFF","#63C7FF","#3192FF","#FFFFFF","#7A3789","#B252CB","#CF5FEC","#DE66FF","#EC7AE7","#FF81F8","#61BD6D", "#1ABC9C", "#54ACD2", "#2C82C9", "#9365B8","REMOVE"],
            colorsStep: 7,
            ...
            function f() {
                ...
                return a += '<span class="fr-colors-tab ' + ("background" == b.opts.colorsDefaultTab ? "" : "fr-selected-tab ") + 'fr-command" tabIndex="-1" role="button" aria-pressed="' + ("background" != b.opts.colorsDefaultTab) + '" data-param1="text" data-cmd="colorChangeSet" title="' + b.language.translate("文字颜色") + '">' + b.language.translate("文字颜色") + "</span>", a += '<span class="fr-colors-tab ' + ("background" == b.opts.colorsDefaultTab ? "fr-selected-tab " : "") + 'fr-command" tabIndex="-1" role="button" aria-pressed="' + ("background" == b.opts.colorsDefaultTab) + '" data-param1="background" data-cmd="colorChangeSet" title="' + b.language.translate("Background") + '">' + b.language.translate("背景颜色") + "</span>", a + "</div>"
            }
            function g(a) {
