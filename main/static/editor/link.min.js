    ...
    function(a) {
        ...
        a.extend(a.FE.POPUP_TEMPLATES, {
            ...
            function l(a) {
                ...
                b.opts.linkAlwaysBlank || (f += '<div class="fr-checkbox-line"><span class="fr-checkbox"><input name="target" class="fr-link-attr" data-checked="_blank" type="checkbox" id="fr-link-target-' + b.id + '" tabIndex="' + ++g + '"><span>' + e + '</span></span><label for="fr-link-target-' + b.id + '">' + b.language.translate("在新的页面中打开") + "</label></div>"), f += '<div class="fr-action-buttons"><button class="fr-command fr-submit" role="button" data-cmd="linkInsert" href="#" tabIndex="' + ++g + '" type="button">' + b.language.translate("确定") + "</button></div></div>";
                var l = {
                        buttons: d,
                        input_layer: f
                    },
                    ...
                    for (var c = b.$el.find(".fr-marker").addClass("fr-unprocessed").toArray(); c.length;) {
                        ...
                        if (e) {
                            var f = d.get(0),
                                g = "",
                                h = "";
                            do f = f.parentNode, b.node.isBlock(f) || (g += b.node.closeTagString(f), h = b.node.openTagString(f) + h);
                            while (f != e);
            ...
            function r(f, g, h) {
                ...
                var l = /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\s\\]+)+)(\\)?$/i;
            ...
            refresh: function(a) {
                var b = this.link.get();
                b ? a.text(this.language.translate("更新")) : a.text(this.language.translate("确定"))
            }
