...
function(a) {
    ...
    a.FE.PLUGINS.table = function(b) {
        ...
        function s() {
            var a = ta(),
            c = a.find("thead");
            if (c.length > 0) if (0 === a.find("tbody tr").length) q();
        ...
        function P(b, c, d, e, f) {
            ...
            m = d,
            n = e;
            for (g = k; g <= l; g++)((parseInt(a(f[g][m]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][m]).attr("colspan"), 10) || 1) > 1) && (i = J(f[g][m], f), j = K(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n)),
            ((parseInt(a(f[g][n]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][n]).attr("colspan"), 10) || 1) > 1) && (i = J(f[g][n], f), j = K(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n));
            for (h = m; h <= n; h++)((parseInt(a(f[k][h]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[k][h]).attr("colspan"), 10) || 1) > 1) && (i = J(f[k][h], f), j = K(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n)),
            ((parseInt(a(f[l][h]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[l][h]).attr("colspan"), 10) || 1) > 1) && (i = J(f[l][h], f), j = K(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n));
        ...
        function U(c) {
            var d = S(c);
            if (sa().length > 0 && !d && T(), !b.edit.isDisabled() || b.popups.isVisible("table.edit")) if (1 != c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey)(3 == c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey) && d && T();
            else if (Aa = !0, d) {
        ...
        function aa() {
            ...
            xa = b.shared.$table_resizer,
            b.events.$on(xa, "mousedown",
            function(a) {
        ...
        function ma(a) {
            if (sa().length > 1 && Aa && N(), Aa === !1 && za === !1 && Da === !1) Ca && clearTimeout(Ca),
        ...
        function oa(c) {
            ...
            if (d == a.FE.KEYCODE.TAB) {
                ...
                T(),
                c.shiftKey ? e.prev().length > 0 ? na(e.prev()) : e.closest("tr").length > 0 && e.closest("tr").prev().length > 0 ? na(e.closest("tr").prev().find("td:last")) : e.closest("tbody").length > 0 && e.closest("table").find("thead tr").length > 0 && na(e.closest("table").find("thead tr th:last")) : e.next().length > 0 ? na(e.next()) : e.closest("tr").length > 0 && e.closest("tr").next().length > 0 ? na(e.closest("tr").next().find("td:first")) : e.closest("thead").length > 0 && e.closest("table").find("tbody tr").length > 0 ? na(e.closest("table").find("tbody tr td:first")) : (e.addClass("fr-selected-cell"), t("below"), M(), na(e.closest("tr").next().find("td:first"))),
                b.selection.restore(),
                !1
            }
        }
        function pa() {
            ...
            function() {
                ...
                "before" == c ? (a.addClass("fr-selected-cell"), d.table.insertColumn(c), a.removeClass("fr-selected-cell")) : "after" == c ? (a.addClass("fr-selected-cell"), d.table.insertColumn(c), a.removeClass("fr-selected-cell")) : "above" == c ? (a.addClass("fr-selected-cell"), d.table.insertRow(c), a.removeClass("fr-selected-cell")) : "below" == c && (a.addClass("fr-selected-cell"), d.table.insertRow(c), a.removeClass("fr-selected-cell")),
                ca()
            }), b.events.on("shared.destroy",
            function() {
        ...
        function va(c) {
            ...
            if (d.length > 0) {
                ...
                if (a.FE.KEYCODE.ARROW_RIGHT == h) {
                    ...
                    !1
                } else if (a.FE.KEYCODE.ARROW_UP == h && i.row > 0) return R(e, g[i.row - 1][i.col]),
                !1
            }
        }
        function wa() {
            ...
            if (!b.helpers.isMobile()) {
                ...
                b.opts.iframe && b.events.$on(a(b.o_win), "mouseup", V),
                b.events.$on(b.$win, "mousemove", ma),
                b.events.$on(a(b.o_win), "scroll", ia),
                b.events.on("contentChanged",
                function() {
                    sa().length > 0 && (d(), b.$el.find("img").on("load.selected-cells",
                    function() {
    ...
    a.FE.RegisterCommand("tableCells", {
        ...
        options: {
            merge: "合并单元格",
            "vertical-split": "垂直拆分单元格",
            "horizontal-split": "水平拆分单元格"
        },
        html: function() {
            var b = '<ul class="fr-dropdown-list" role="presentation">',
