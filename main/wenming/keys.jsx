...
class ZmitiWenmingKeysApp extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    var s = this;
    var title = this.props.params.title || '文明网热词';
    ...
    var component = <div className="zmitiwenming-keys-main-ui" style={{height:this.state.mainHeight}}>
        <div className='pad-10'>
            <div className="zmiti-keys-header">
                <Row>
                    <Col span={8} className="zmiti-keys-header-inner">文明网热词</Col>                    
  ...
  /*设置热词*/
  openkey() {
    window.location.href = './#/wenmingkeysopt/';
  }
...
export default ZmitiValidateUser(ZmitiWenmingKeysApp);
