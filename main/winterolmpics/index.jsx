...
class ZmitiWinterOlmpicsApp extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		var title = this.props.params.title || '冬奥会';
		let props = {
	...
	componentWillMount() {
		...
		var index = -1;
		window.WINTEROLMPICSUSERLIST.forEach((item, i) => {
			if (item === username) {
				index = i;
			}
		});
...
export default ZmitiValidateUser(ZmitiWinterOlmpicsApp);
