...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	    (function () {
	        var ReactHotAPI = require("E:\\project\\ZPlatform\\node_modules\\.0.4.7@react-hot-api\\modules\\index.js"),
	            RootInstanceProvider = require("E:\\project\\ZPlatform\\node_modules\\.1.3.1@react-hot-loader\\RootInstanceProvider.js"),
	    ...
	    if (false) {
	        (function () {
	            var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	                var makeExportsHot = require("E:\\project\\ZPlatform\\node_modules\\.1.3.1@react-hot-loader\\makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	                    foundReactClasses = true;
	                }var shouldAcceptModule = true && foundReactClasses;if (shouldAcceptModule) {
	                    module.hot.accept(function (err) {
	                        if (err) {
	                            console.error("Cannot apply hot update to " + "index.es6" + ": " + err.message);
	                        }
	                    });
	                }
