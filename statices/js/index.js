	                    ...
	                    success: function success(d) {
	                        ...
	                        if (d.getret === 0) {
	                            ...
	                            /*
	                                ...
	                                (0, _jquery2['default'])('#fly-msg').html(d.getmsg).addClass('active');
	                                setTimeout(function () {
	                                    (0, _jquery2['default'])('#fly-msg').removeClass('active');
	                                }, 2000);
	                                (0, _jquery2['default'])(e.target).removeClass("shadow").removeClass("hide").parent().find('.loading').removeClass("show");
	                            }
	                    }
	                });
